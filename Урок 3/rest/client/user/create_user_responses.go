...
func (o *CreateUserReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /v1/users] createUser", response, response.Code())
	}
}
...
func (o *CreateUserCreated) Error() string {
	return fmt.Sprintf("[POST /v1/users][%d] createUserCreated  %+v", 201, o.Payload)
}
...
func (o *CreateUserBadRequest) GetPayload() *models.ErrorMessage {
	return o.Payload
}
...
func (o *CreateUserConflict) GetPayload() *models.ErrorMessage {
	return o.Payload
}
...
func (o *CreateUserInternalServerError) GetPayload() *models.ErrorMessage {
	return o.Payload
}
